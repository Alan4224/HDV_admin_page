...
const analysisSentences = [ 
  "Đây là phân khúc có doanh số <b>cao nhất</b> với <b>{totalSale}</b> xe bán ra, chiếm <b>{percentage}%</b> tổng xe bán được. Điều này cho thấy xe trong tầm giá này rất phổ biến và được nhiều người tiêu dùng lựa chọn.", 
  "Phân khúc này có doanh số <b>{totalSale}</b> xe, chiếm <b>{percentage}%</b> tổng xe bán được, cho thấy sự phổ biến và ưa chuộng của các mẫu xe tầm giá này.", 
  "Phân khúc này có doanh số khá lớn với <b>{totalSale}</b> xe bán ra, chiếm <b>{percentage}%</b> tổng xe bán được, thể hiện sự ưa chuộng của người tiêu dùng đối với các mẫu xe trong tầm giá này.", 
  "Phân khúc này có doanh số <b>{totalSale}</b> xe, chiếm <b>{percentage}%</b> tổng xe bán được, cho thấy một lượng người tiêu dùng sẵn lòng chi trả cho xe tầm giá này.", 
  "Có <b>{totalSale}</b> xe bán ra trong phân khúc này, chiếm <b>{percentage}%</b> tổng xe bán được, nhưng vẫn đáng kể đối với xe tầm giá này.", 
  "Có <b>{totalSale}</b> xe bán ra trong phân khúc này, chiếm <b>{percentage}%</b> tổng xe bán được, điều này cho thấy sự lựa chọn hạn chế của người tiêu dùng đối với các mẫu xe này.", 
  "Mức giá này có doanh số thấp nhất với chỉ <b>{totalSale}</b> xe bán ra, chiếm <b>{percentage}%</b> tổng xe bán được. Điều này cho thấy xe trong phân khúc giá này không phổ biến trên thị trường."
];
