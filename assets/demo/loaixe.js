$(document).ready(function() {
    const apiUrl = 'https://car-management-1.onrender.com/loai-xe/getAll';
    ...
    function deleteRow(id) {
        if (confirm('Bạn có chắc chắn muốn xóa hàng này?')) {
            $.ajax({
                url: `https://car-management-1.onrender.com/loai-xe/${id}`, // Đổi 'delete-url' thành URL cụ thể của bạn
                method: 'DELETE',
                success: function() {
    ...
    $('#addNewBtn').on('click', function() {
        $.ajax({
            url: 'https://car-management-1.onrender.com/loai-xe/craw', // Đổi 'your-url' thành URL cụ thể của bạn
            method: 'GET',
